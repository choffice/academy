let tmlist = '기본선택자:기본선택자/속성선택자:속성선택자'.split('/');

if(location.href.includes('index.html')){
for(a_tm of tmlist){
homemenu.innerHTML+='<li><a href="0'+(tmlist.indexOf(a_tm)+1)+'_'+a_tm.split(':')[1]+'.html">'+a_tm.split(':')[0]+'</a></li>'
}
}else{
...
for(a_tm of tmlist){topmenu.innerHTML+='<li style="margin-inline:2%;background:green;padding:1%;"><a href="0'+(tmlist.indexOf(a_tm)+1)+'_'+a_tm.split(':')[1]+'.html" style="text-decoration: none;color:#fff;">'+a_tm.split(':')[0]+'</a></li>';}
